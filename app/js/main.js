...
},{"./ajax_setup":1,"./router":3,"jquery":8}],3:[function(require,module,exports){
'use strict';
...
var Router = _backbone2['default'].Router.extend({
  ...
  showIndivualTodo: function showIndivualTodo(todoId) {
...
},{"./todos_collection":4,"./views/home":5,"./views/todos":6,"backbone":7}],4:[function(require,module,exports){
'use strict';
